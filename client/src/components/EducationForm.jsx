                        ...
                        <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
                            ...
                            <div className='grid md:grid-cols-2 gap-3'>
                                ...
                                <input value={education.degree || ""} 
                                    ...
                                    type="text" placeholder="Degree (e.g., Bachelor's, Master's)" className="px-3 py-2 text-sm rounded-lg" />
                            ...
                            <input value={education.gpa || ""} 
                                ...
                                type="text" className="w-full px-3 py-2 text-sm rounded-lg" placeholder="GPA (optional)" />
                        </div>
                    ))}
                </div>
            )}
