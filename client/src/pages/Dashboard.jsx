  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <p className="text-2xl font-medium mb-6 bg-gradient-to-r from from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden">
          Welcome, Name
        </p>
          ...
          >
            ...
            >
              ...
              <input
                ...
                className="w-full px-4 py-2 mb-4 border rounded outline-none focus:border-green-600 ring-green-600 "
                required
              />
